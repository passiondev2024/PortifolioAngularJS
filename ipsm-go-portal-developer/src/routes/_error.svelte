...
<svelte:body class="bg-gray-300" ></svelte:body>
    ...
    <div class="container mx-auto px-4">
      <section class="py-8 px-4 text-center">
        <div class="max-w-auto mx-auto">
          ...
          <a
            href="./dashboard"
            class="mt-6 bg-green-500 hover:bg-green-700 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-md"
