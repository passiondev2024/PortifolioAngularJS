...
<svelte:head>
  <title>Atualizar Informações de Apps| Portal Previdenciário do Servidor</title>
</svelte:head>
...
<div id="head"
  ...
  <h1 class="text-2xl">
    <i class="fa fa-redo" /> Atualizar Informações de Apps
  </h1>
</div>
<div
    ...
    <thead class="">
      <tr>
        ...
        <th
          ...
          Data de criação</th>
        <th
          class="dark:bg-gray-600 dark:text-white font-bold  bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">
